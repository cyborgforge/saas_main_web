    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden pb-20" style={{
        ...
        <div className="max-w-5xl mx-auto px-12 pt-10 relative">
          ...
          <div className="text-center relative z-10">
            ...
            <h1 className="text-5xl -mt-3 md:text-6xl font-bold text-gray-900 leading-tight mb-8" style={{ fontFamily: "var(--font-anton)" }}>
      ...
      <section className="py-16 bg-[#dce1ff] relative">
        ...
        <div className="max-w-6xl mx-6 px-12">
          <h2 className="font-serif text-center text-4xl font-normal text-gray-900 mb-4" style={{ fontFamily: "var(--font-anton)" }}>Our values</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[14px] font-semibold text-gray-900">Take pride in your work</h3>
                  <p className="text-gray-600 text-[13px]">{"Be bold and aspire for excellence. Let's build a lasting company."}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[14px] font-semibold text-gray-900">Be an owner</h3>
                  <p className="text-gray-600 text-[13px]">Owners sweep the floors and take out the trash. They do {"what's"} best for the customer and company, and are always accountable to their teammates.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[14px] font-semibold text-gray-900">Always be learning</h3>
                  <p className="text-gray-600 text-[13px]">Improve every day; feedback and reflection will make us all better.</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[14px] font-semibold text-gray-900">Empower others</h3>
                  <p className="text-gray-600 text-[13px]">{"We exist to empower customers; we'll succeed by empowering each other."}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-[14px] font-semibold text-gray-900">Embrace the journey</h3>
                  <p className="text-gray-600 text-[13px]">Appreciate the entire experience, win as a team, and have fun.</p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-[#020c1c]">
        <div className="max-w-4xl mx-auto px-2">
          <div className="bg-[#121627] rounded-2xl p-12 text-center">
            <div className="text-6xl text-[#6366F1] mb-6">"</div>
            <p className="text-white text-lg md:text-xl mb-8">
              {testimonials[testimonialIndex].quote}
            </p>
            <div className="flex items-center justify-center gap-4 mb-4">
              <div className="w-16 h-16 bg-gradient-to-br from-[#F4A261] to-[#E76F51] rounded-2xl flex items-center justify-center overflow-hidden">
