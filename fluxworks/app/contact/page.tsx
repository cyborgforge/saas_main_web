    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden pb-20" style={{
        ...
        <div className="max-w-7xl mx-6 py-16 text-center">
          ...
          <p className="text-gray-600 max-w-xl text-sm mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[13px] text-gray-900">Email</h3>
                    <p className="text-gray-600 text-[13px]">hello@Cloud-saas.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[13px] text-gray-900">Phone</h3>
                    <p className="text-gray-600 text-[13px]">+1 (800) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[13px] text-gray-900">Office</h3>
                    <p className="text-gray-600 text-[13px]">123 Innovation Drive<br/>San Francisco, CA 94105</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 bg-[#f0f5f7] p-6 rounded-2xl">
                <h3 className="font-semibold text-[12px] text-gray-900 mb-3">Working Hours</h3>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-sm">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-2.5 py-2 text-[12px] border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4a90a4] focus:border-transparent"
                  />
                </div>
                <div>
                  <label className="block text-[12px] font-medium text-gray-700 mb-2">
              ...
              <div className="mt-6">
                ...
                <select className="w-full px-2.5 py-2 text-[12px] border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4a90a4] focus:border-transparent bg-white text-gray-500">
              ...
              <div className="mt-6">
                ...
                <textarea 
                  ...
                  className="w-full px-2.5 py-2 text-[12px] border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4a90a4] focus:border-transparent resize-none"
                />
              </div>

              <button className="w-full mt-6 bg-[#4a90a4] text-[12px] text-white py-2 rounded-lg font-medium hover:bg-[#3d7a8a] flex items-center justify-center gap-2">
                Send Message
