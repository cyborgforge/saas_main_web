        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-1.5">
            <div>
              ...
              <input
                ...
                className="w-full px-2 py-1.5 text-[12px] border border-[#a8b8e8] rounded-full bg-transparent text-gray-800 outline-none focus:border-[#7b8cde] focus:ring-1 focus:ring-[#7b8cde] transition-colors"
                required
              />
            </div>
            ...
            <button
              type="submit"
              className="w-full py-1.5 mt-2 text-[12px] bg-black text-white font-semibold rounded-full hover:bg-gray-900 transition-colors cursor-pointer"
            >
              Register
            </button>
          </form>
          ...
          <div className="flex items-center justify-center gap-2.5 mt-1.5">
            <a
              href="#"
              aria-label="Facebook"
              className="text-[#7b8cde] hover:opacity-80 transition-opacity"
            >
              <svg
